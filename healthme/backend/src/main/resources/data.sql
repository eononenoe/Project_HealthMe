...
INSERT INTO nutrient_result_desc (`id`, `nutrient_name`, `range_start`, `description`, `tip`, `foods`) VALUES
(1,'단백질',0,'단백질이 매우 부족한 상태입니다. 닭가슴살이나 두부 같은 식품 섭취가 도움이 됩니다.','매 끼니 단백질 반찬을 포함해보세요.','닭가슴살,두부,삶은계란'),
(2,'단백질',20,'단백질 보충이 필요합니다. 계란이나 콩류를 식단에 추가해보세요.','아침에 삶은 계란 한 개를 추가해보세요.','계란,렌틸콩,두유'),
(3,'단백질',40,'단백질 섭취가 보통입니다. 생선이나 요거트를 꾸준히 섭취하면 좋습니다.','요거트를 간식으로 활용해보세요.','연어,요거트,두유'),
(4,'단백질',60,'단백질 상태가 양호합니다. 낫또, 렌틸콩 등을 함께 활용해보세요.','현재 식단을 꾸준히 유지하는 것이 좋습니다.','낫또,렌틸콩,두부'),
(5,'단백질',80,'단백질이 충분한 상태입니다. 식단 균형을 유지해주세요.','단백질 과잉을 피하고 채소 섭취를 늘리세요.','닭가슴살,두부,시금치'),
(6,'단백질',100,'단백질 섭취가 다소 과한 편입니다. 신장 부담에 주의하세요.','단백질 보충제를 줄이고 식물성 위주로 전환해보세요.','두유,아몬드,채소류'),
(7,'철분',0,'철분이 심각하게 부족합니다. 간, 시금치, 조개류 등이 좋습니다.','빈혈 증상이 있다면 빠른 보충이 필요합니다.','간,시금치,홍합'),
(8,'철분',20,'철분 보충이 필요합니다. 붉은살 생선이나 비트 등을 참고해보세요.','비타민 C와 함께 섭취하면 흡수율이 증가합니다.','고등어,비트,오렌지'),
(9,'철분',40,'철분 섭취가 보통입니다. 철분이 함유된 곡물류도 괜찮습니다.','철분 보충제를 필요 시점에만 사용하세요.','귀리,강낭콩,계란'),
(10,'철분',60,'철분 상태가 양호합니다. 꾸준히 유지하세요.','지속적인 채소 중심 식단이 좋습니다.','시금치,잡곡밥,계란'),
(11,'철분',80,'철분 섭취가 많습니다. 비타민 C와 함께 흡수율을 고려하세요.','보충제를 사용 중이라면 용량을 조절하세요.','쇠고기,자두,아몬드'),
(12,'철분',100,'철분 과잉 상태일 수 있습니다. 복용 중인 보충제를 점검해보세요.','간기능 수치를 확인해보는 것도 좋습니다.','시금치,두부,과일'),
(13,'비타민 D',0,'비타민 D가 매우 부족합니다. 연어, 계란노른자 등이 유익합니다.','햇볕을 하루 15분 이상 쬐는 것이 중요합니다.','연어,계란노른자,강화우유'),
(14,'비타민 D',20,'비타민 D 보충이 필요합니다. 표고버섯이나 강화 우유를 참고하세요.','우유나 버섯을 식단에 포함해보세요.','표고버섯,강화우유,계란'),
(15,'비타민 D',40,'비타민 D 상태가 보통입니다. 햇볕 노출과 식단을 병행하세요.','주 2~3회 외부활동이 도움이 됩니다.','우유,버섯,달걀'),
(16,'비타민 D',60,'비타민 D 상태가 좋습니다. 유지를 위해 꾸준히 관리하세요.','운동 후 야외활동을 병행해보세요.','연어,강화우유,계란'),
(17,'비타민 D',80,'다소 많은 섭취 상태입니다. 기능성 식품은 조절이 필요합니다.','보충제를 잠시 중단해보세요.','우유,달걀,두부'),
(18,'비타민 D',100,'과다 섭취 우려가 있습니다. 혈중 농도 확인을 권장합니다.','검진을 통해 농도를 체크하세요.','버섯,두유,강화우유'),
(19,'칼슘',0,'칼슘이 부족한 상태입니다. 우유, 멸치, 두부 등 섭취가 도움됩니다.','우유 1컵을 하루에 추가해보세요.','우유,멸치,두부'),
(20,'칼슘',20,'칼슘 보충이 필요합니다. 요거트나 치즈도 좋은 선택입니다.','간식으로 치즈를 활용해보세요.','치즈,요거트,두유'),
(21,'칼슘',40,'칼슘 상태가 보통입니다. 해조류 섭취도 고려해보세요.','김이나 다시마를 곁들여보세요.','다시마,김,두부'),
(22,'칼슘',60,'칼슘이 충분합니다. 유지가 중요합니다.','운동 후 유제품 섭취가 좋습니다.','요거트,우유,두부'),
(23,'칼슘',80,'칼슘 섭취가 많습니다. 비타민 D와의 균형을 고려하세요.','비타민 D를 병행 섭취하세요.','두부,시금치,우유'),
(24,'칼슘',100,'과도한 칼슘은 신장 부담이 될 수 있습니다. 주의하세요.','검진을 통해 신장 기능을 점검해보세요.','우유,멸치,견과류'),
(25,'식이섬유',0,'식이섬유가 매우 부족합니다. 양배추, 고구마 등이 좋습니다.','하루 한 끼 이상 채소 반찬을 넣어보세요.','양배추,고구마,상추'),
(26,'식이섬유',20,'보충이 필요합니다. 사과나 귀리도 고려해보세요.','과일 간식으로 대체해보세요.','사과,귀리,오트밀'),
(27,'식이섬유',40,'식이섬유 섭취가 보통입니다. 콩류나 해조류를 함께 드세요.','밥에 콩을 넣어보는 것도 방법입니다.','콩,미역,김'),
(28,'식이섬유',60,'충분한 상태입니다. 다양한 채소 섭취를 유지하세요.','녹색 채소를 꾸준히 섭취하세요.','브로콜리,양상추,시금치'),
(29,'식이섬유',80,'다소 많은 편입니다. 복부 팽만감에 주의하세요.','물 섭취를 늘리면 도움이 됩니다.','양배추,고구마,견과류'),
(30,'식이섬유',100,'지나친 섭취는 배변 활동에 영향을 줄 수 있어요.','식이섬유 보충제를 줄이세요.','귀리,콩,시리얼'),
(31,'마그네슘',0,'마그네슘이 매우 부족한 상태입니다. 두부, 시금치, 바나나 등이 좋습니다.','견과류나 통곡물 간식을 추가해보세요.','두부,시금치,바나나'),
(32,'마그네슘',20,'마그네슘 보충이 필요합니다. 현미나 해바라기씨를 고려해보세요.','아침 식사에 통곡물 시리얼을 넣어보세요.','현미,해바라기씨,아몬드'),
(33,'마그네슘',40,'마그네슘 섭취가 보통입니다. 녹색채소와 해조류로 균형을 맞추세요.','식단에 해조류를 곁들여 보세요.','시금치,김,아보카도'),
(34,'마그네슘',60,'마그네슘 상태가 양호합니다. 균형 잡힌 식사를 유지하세요.','운동 후 바나나와 견과류를 간식으로 섭취해보세요.','바나나,캐슈넛,두부'),
(35,'마그네슘',80,'마그네슘 섭취가 다소 많은 상태입니다. 보충제 사용량을 점검하세요.','식물성 위주 식단으로 조절해보세요.','귀리,두유,통밀빵'),
(36,'마그네슘',100,'과다 섭취는 설사나 위장 장애를 유발할 수 있습니다.','보충제를 중단하고 식사 위주 섭취로 전환해보세요.','두유,현미,채소류'),
(37,'칼륨',0,'칼륨이 매우 부족한 상태입니다. 바나나, 감자, 아보카도 섭취가 좋습니다.','하루 한 번 과일을 간식으로 챙겨보세요.','바나나,감자,아보카도'),
(38,'칼륨',20,'칼륨 보충이 필요합니다. 채소나 콩류를 함께 섭취하세요.','국이나 반찬에 콩나물을 넣어보세요.','콩나물,당근,두부'),
(39,'칼륨',40,'칼륨 섭취가 보통입니다. 다양한 채소와 과일을 유지하세요.','식단에 삶은 야채를 자주 포함해보세요.','브로콜리,사과,양상추'),
(40,'칼륨',60,'칼륨 상태가 양호합니다. 꾸준히 식이섬유와 함께 섭취하세요.','식사 중 나트륨을 줄이고 채소 비중을 늘려보세요.','오이,시금치,키위'),
(41,'칼륨',80,'칼륨 섭취가 많습니다. 신장 질환이 있다면 주의가 필요합니다.','보충제를 사용 중이라면 복용량을 점검하세요.','토마토,바나나,고구마'),
(42,'칼륨',100,'칼륨 과잉은 심장 기능에 영향을 줄 수 있습니다.','의사 상담을 통해 수치를 점검하고 식단을 조절하세요.','과일류,감자,두유'),
(43,'비오틴',0,'비오틴이 매우 부족한 상태입니다. 탈모나 피부 트러블로 나타날 수 있습니다.','달걀노른자나 아보카도를 자주 섭취해보세요.','달걀노른자,아보카도,견과류'),
(44,'비오틴',20,'비오틴 보충이 필요합니다. 육류나 콩류도 좋은 공급원입니다.','주 2~3회 고기 반찬을 곁들여 보세요.','닭고기,대두,달걀'),
(45,'비오틴',40,'비오틴 섭취가 보통입니다. 균형 잡힌 식단을 유지하세요.','견과류나 통곡물 간식을 포함해보세요.','귀리,해바라기씨,호두'),
(46,'비오틴',60,'비오틴 상태가 양호합니다. 비타민 B 복합군도 함께 챙기세요.','비오틴은 수용성이므로 꾸준히 섭취가 필요합니다.','달걀,아보카도,강낭콩'),
(47,'비오틴',80,'비오틴 섭취가 많은 편입니다. 과용하지 않도록 주의하세요.','보충제는 용법에 맞게 복용하세요.','비오틴보충제,간,계란'),
(48,'비오틴',100,'비오틴 과잉은 드물지만, 혈액검사에 영향을 줄 수 있습니다.','과도한 보충은 피하고 식이 위주로 유지하세요.','달걀,견과류,채소류'),
(49,'아연',0,'아연이 심각하게 부족합니다. 면역력 저하나 상처 회복 지연이 나타날 수 있습니다.','굴이나 소고기 등 아연이 풍부한 식품을 섭취하세요.','굴,쇠고기,해바라기씨'),
(50,'아연',20,'아연 보충이 필요합니다. 육류나 해조류도 좋은 공급원입니다.','주 2회 이상 고기 반찬을 포함해보세요.','소고기,김,계란'),
(51,'아연',40,'아연 섭취가 보통입니다. 식물성과 동물성을 균형 있게 유지하세요.','견과류와 해조류를 함께 섭취해보세요.','호박씨,김,닭고기'),
(52,'아연',60,'아연 상태가 양호합니다. 다양한 식품을 통해 꾸준히 유지하세요.','철분, 아연 흡수를 방해하지 않도록 식사 간격에 유의하세요.','현미,달걀,콩'),
(53,'아연',80,'아연 섭취가 많은 편입니다. 장기 복용 시 구리 결핍에 주의하세요.','아연 보충제 사용 시 전문가 상담을 권장합니다.','보충제,육류,해산물'),
(54,'아연',100,'아연 과다 복용은 메스꺼움이나 설사를 유발할 수 있습니다.','식이 위주로 유지하고, 보충제 사용은 일시 중단하세요.','계란,두부,호두'),
(55,'아르기닌',0,'아르기닌이 매우 부족한 상태입니다. 성장 및 회복에 어려움을 줄 수 있습니다.','닭가슴살이나 견과류를 추가해보세요.','닭가슴살,호두,아몬드'),
(56,'아르기닌',20,'아르기닌 보충이 필요합니다. 콩류나 육류를 섭취해보세요.','두유나 삶은 달걀을 식단에 포함해보세요.','두유,계란,렌틸콩'),
(57,'아르기닌',40,'아르기닌 섭취가 보통입니다. 꾸준한 유지가 필요합니다.','운동 후 단백질 식품과 함께 섭취해보세요.','계란,소고기,호박씨'),
(58,'아르기닌',60,'아르기닌 상태가 양호합니다. 다양한 식품에서 균형 있게 섭취하세요.','하루 1끼는 단백질 중심 식사로 구성해보세요.','닭가슴살,콩,아보카도'),
(59,'아르기닌',80,'아르기닌 섭취가 많은 편입니다. 보충제 사용량을 확인해보세요.','보충제 복용 시 하루 권장량을 초과하지 않도록 주의하세요.','보충제,육류,견과류'),
(60,'아르기닌',100,'아르기닌 과잉은 복부 불편감이나 저혈압을 유발할 수 있습니다.','자연 식품 위주 섭취로 전환하고 보충은 제한하세요.','두유,호박씨,두부');
