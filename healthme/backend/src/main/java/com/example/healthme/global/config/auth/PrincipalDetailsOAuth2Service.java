...
import com.example.healthme.global.config.auth.provider.GoogleUserInfo;
import com.example.healthme.global.config.auth.provider.KakaoUserInfo;
import com.example.healthme.global.config.auth.provider.NaverUserInfo;
import com.example.healthme.global.config.auth.provider.OAuth2UserInfo;
