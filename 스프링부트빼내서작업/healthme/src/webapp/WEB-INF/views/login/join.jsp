...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/login/join.css">
    <script src="${pageContext.request.contextPath}/static/js/by.js"></script>
    <!-- js -->
...
<body>
    ...
    <div class="join_box">
        <div class="box1">
            ...
            <!-- 비밀번호 재확인 -->
            <input type="password2" name="userpw2" class="custom-input" placeholder="비밀번호 재확인" id="password2">
            <!-- 이름 -->
